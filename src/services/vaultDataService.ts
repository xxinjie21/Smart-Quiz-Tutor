...
import type { HistoryEntry, PluginSettings, WrongAnswerNote } from "../types";
import { parseFM, buildFM } from "../utils/frontmatter";
import { isAbs, ensureFolderAbs, writeFileStr, readFileStr, listMdFilesRecursive, ensureFolder, isExcludedPath, joinPath } from "../utils/fs-utils";
...
export class VaultDataService {
	...
	async deleteWrongNote(filePath: string): Promise<void> {
		...
		await this.p.rebuildKnowledgeIndex();
	}
